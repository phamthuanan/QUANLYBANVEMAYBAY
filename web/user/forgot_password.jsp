<%-- 
    ...
    Created on : Oct 19, 2020, 2:00:30 PM
    Author     : Duong Nguyen
--%>
                        ...
                        <form class="auth__form" method="post" action="">
                            ...
                            <div class="row">
                                <div style="float: left;padding-left: 20px;">
                                    <button type="submit" name="Save" class="book-btn">Lấy lại mật khẩu</button>
                                </div>
                                <div class="col-md-8" style="display: flex !important; padding: 10px 20px;margin-left: 55px;">
                                    <span class="el-sub" style="padding: 0 5px;">Quay về trang</span>
                                    <a href="login.jsp">
