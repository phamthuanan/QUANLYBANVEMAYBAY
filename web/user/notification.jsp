<%-- 
    ...
    Created on : Oct 19, 2020, 2:02:11 PM
    Author     : Duong Nguyen
--%>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6" style="margin-left: 25%">
                        ...
                        <p class="text-center el-text">
                            <b>Đặt vé thành công!</b>
                        </p>
                        <p>Cảm ơn Quý khách đã sử dụng dịch vụ của Vivu Travel </p>
                        <p>Mã đơn hàng của Quý khách là: <b class="el-text">2010285128</b></p>
                        <p>Chúng tôi đã gửi thông tin xác nhận đặt chỗ và thời hạn thanh toán vào số điện thoại <b>098 765 43 21</b> của Quý khách. </p>
                        <p>Quý khách vui lòng kiểm tra và thanh toán trước thời hạn thông báo để đảm bảo giá vé không thay đổi.</p>
                        <p>Nếu cần hỗ trợ thêm, Quý khách vui lòng gọi tổng đài: 19001000. Vivu Travel rất hân hạnh được phục vụ.</p>
                    </div>
                </div>
            </div>
            <div style="text-align: center; margin-bottom: 30px">
                <button type="submit" class="book-btn" onclick="window.location.href='index.jsp'">Về trang chủ</button>
            </div>
        </section>
